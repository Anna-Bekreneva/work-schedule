...
export const useSchedule = () => {
  ...
  const restDaysHandle = (e: ChangeEvent<HTMLInputElement>) =>
    setRestDays(Number(e.currentTarget?.value))

  const setWorksHandle = (e: ChangeEvent<HTMLInputElement>) =>
    setWorkDays(Number(e.currentTarget.value))
